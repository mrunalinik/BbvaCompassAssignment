...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void requestForLocPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this, ACCESS_FINE_LOCATION)) {
            ...
            if (Utility.getLocationPermission(MainActivity.this)) {
                Utility.setLocationPermission(false, MainActivity.this);
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        switch (requestCode) {
            case REQUEST_LOCATION:
                ...
                break;
            case REQUEST_LOCATION_RATIONALE:
